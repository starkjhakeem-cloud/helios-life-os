...
class AutonomyAuditLog(Base):
    __tablename__ = "autonomy_audit_log"
    ...
    source: Mapped[str] = mapped_column(String(100), nullable=False, default="helios")
    ...
    __table_args__ = (
        Index("ix_autonomy_audit_log_user_created", "user_id", "created_at"),
    )
